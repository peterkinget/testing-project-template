...
C {model_pll/vco_model.sym} 1210 -430 0 0 {name=xVCO}
...
C {model_pll/freq_divider.sym} 1200 -180 0 1 {name=xDIV divide_factor=\{divide_factor\}}
...
C {model_pll/pfd_model.sym} 190 -390 0 0 {name=xPFD}
...
C {model_pll/CP_model.sym} 480 -410 0 0 {name=x1}
